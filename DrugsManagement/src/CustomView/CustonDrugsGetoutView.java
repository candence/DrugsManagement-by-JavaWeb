...
public class CustonDrugsGetoutView {
	...
	private void initialize() {
		...
		label_1.setBounds(20, 122, 92, 15);
		...
		textField_number.setBounds(368, 124, 78, 21);
		...
		button_.setBounds(167, 375, 93, 23);
		...
		button_1cancel.setBounds(326, 375, 93, 23);
		...
		button_return.setBounds(485, 375, 93, 23);
		...
		button_update.setBounds(10, 375, 93, 23);
		...
		label_2.setBounds(30, 207, 77, 15);
		...
		textField_data.setBounds(368, 209, 78, 21);
		frame.getContentPane().add(textField_data);
		
		lblNewLabel_1 = new JLabel("New label");
		lblNewLabel_1.setIcon(new ImageIcon(CustonDrugsGetoutView.class.getResource("/img/logo.jpg")));
		lblNewLabel_1.setBounds(506, 8, 93, 82);

...
public class ManageGetinShowView {
	 ...
	 */
	public ManageGetinShowView() {
		initialize();
	}

	private void initJtable() {
		table = new JTable();
		String[][] result = getindao.getInstance().list(currpageNum);
	...
	private void initialize() {
		...
		btnexcel.setBounds(10, 323, 94, 23);
		...
		button_5.setBounds(593, 323, 93, 23);
		...
		button_6.setBounds(820, 323, 120, 23);
		...
		lblNewLabel.setIcon(new ImageIcon(ManageGetinShowView.class.getResource("/img/logo.jpg")));
		lblNewLabel.setBounds(405, 323, 94, 76);

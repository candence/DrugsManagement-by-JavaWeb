...
public class ManageGetoutShowView {
	...
	private void initialize() {
		...
		btnexcel.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				frame.dispose();
				getoutdao.getInstance().ReadExcelFromDb();
				new manageView();
			}
		});
		btnexcel.setBounds(10, 332, 94, 23);
		...
		button_5.setBounds(593, 332, 93, 23);
		...
		button_6.setBounds(820, 332, 120, 23);
		...
		lblNewLabel.setIcon(new ImageIcon(ManageGetoutShowView.class.getResource("/img/logo.jpg")));
		lblNewLabel.setBounds(387, 302, 106, 101);
